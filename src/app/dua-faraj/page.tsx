          ...
          <Card className="bg-gradient-to-br from-teal-50 to-cyan-50 border-2 border-teal-200 p-8 md:p-12">
            <div className="text-center space-y-8">
              ...
              <div className="space-y-4">
                ...
                >
                  <Heart className={`h-6 w-6 ${dir === 'rtl' ? 'ml-3' : 'mr-3'}`} />
                  <span style={{ fontFamily: 'var(--font-vazirmatn)' }}>
                    {t.duaFaraj.reciteDua}
                  </span>
                  <Heart className={`h-6 w-6 ${dir === 'rtl' ? 'mr-3' : 'ml-3'}`} />
                </Button>
          ...
          <Card className="bg-white border-2 border-yellow-200 p-6 md:p-8">
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-br from-teal-50 to-cyan-50 border-2 border-teal-200 rounded-lg p-6 md:p-8">
                <p className="text-xl md:text-3xl font-bold text-foreground leading-loose text-right mb-6" style={{ fontFamily: 'var(--font-kitab)', direction: 'rtl' }}>
                ...
                <div className="text-muted-foreground leading-relaxed">
                  ...
                  <p className="text-base md:text-lg whitespace-pre-line">{t.duaFaraj.translation}</p>
                </div>
              </div>
